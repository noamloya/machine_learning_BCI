...
CSV_COLUMN_NAMES = ['Tas', 'Stai', 'Stroop', 'Adap', 'Sd_diff']  # Change feature columns when features change.
SUCCESS_INDEX = [0, 1]  # defined by 65 percentile of S MIN
TEST_PERCENT = 0.2


def load_data(data_path, y_name=CSV_COLUMN_NAMES[-1], is_stratified_sampling=False):
